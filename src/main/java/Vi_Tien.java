...
public class Vi_Tien {
    ...
    public float getBalance() {
        float total = 0;
        for (Map.Entry<String, TransactionOutput> item: VQD_Chain.UTXOs.entrySet()){
    ...
    public Transaction sendFunds(PublicKey _recipient,float value ) {
        if(getBalance() < value) {
            System.out.println("#Tai khoan khong du de chuyen tien, giao dich bi huy!");
            return null;
        }
